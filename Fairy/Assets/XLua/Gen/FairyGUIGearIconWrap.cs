...
namespace XLua.CSObjectWrap
{
    ...
    public class FairyGUIGearIconWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(FairyGUI.GearIcon);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<FairyGUI.GObject>(L, 2))
				{
					...
					FairyGUI.GearIcon gen_ret = new FairyGUI.GearIcon(_owner);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to FairyGUI.GearIcon constructor!");
        ...
        static int _m_Apply(RealStatePtr L)
        {
		    try {
                ...
                FairyGUI.GearIcon gen_to_be_invoked = (FairyGUI.GearIcon)translator.FastGetCSObj(L, 1);
