...
namespace XLua.CSObjectWrap
{
    ...
    public class FairyGUIControllerWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 14, 7, 3);
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "GetPageId", _m_GetPageId);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_GetPageId(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    int _index = LuaAPI.xlua_tointeger(L, 2);
                        ...
                        string gen_ret = gen_to_be_invoked.GetPageId( _index );
                        LuaAPI.lua_pushstring(L, gen_ret);
