...
namespace XLua.CSObjectWrap
{
    ...
    public class FairyGUIScrollPaneWrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.CLS_GETTER_IDX, "TWEEN_TIME_GO", _g_get_TWEEN_TIME_GO);
            Utils.RegisterFunc(L, Utils.CLS_GETTER_IDX, "TWEEN_TIME_DEFAULT", _g_get_TWEEN_TIME_DEFAULT);
            Utils.RegisterFunc(L, Utils.CLS_GETTER_IDX, "PULL_RATIO", _g_get_PULL_RATIO);
            
			Utils.RegisterFunc(L, Utils.CLS_SETTER_IDX, "TWEEN_TIME_GO", _s_set_TWEEN_TIME_GO);
            Utils.RegisterFunc(L, Utils.CLS_SETTER_IDX, "TWEEN_TIME_DEFAULT", _s_set_TWEEN_TIME_DEFAULT);
            Utils.RegisterFunc(L, Utils.CLS_SETTER_IDX, "PULL_RATIO", _s_set_PULL_RATIO);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_TWEEN_TIME_GO(RealStatePtr L)
        {
		    try {
            
			    LuaAPI.lua_pushnumber(L, FairyGUI.ScrollPane.TWEEN_TIME_GO);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_TWEEN_TIME_DEFAULT(RealStatePtr L)
        {
		    try {
            
			    LuaAPI.lua_pushnumber(L, FairyGUI.ScrollPane.TWEEN_TIME_DEFAULT);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_PULL_RATIO(RealStatePtr L)
        {
		    try {
            
			    LuaAPI.lua_pushnumber(L, FairyGUI.ScrollPane.PULL_RATIO);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _s_set_TWEEN_TIME_GO(RealStatePtr L)
        {
		    try {
                
			    FairyGUI.ScrollPane.TWEEN_TIME_GO = (float)LuaAPI.lua_tonumber(L, 1);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _s_set_TWEEN_TIME_DEFAULT(RealStatePtr L)
        {
		    try {
                
			    FairyGUI.ScrollPane.TWEEN_TIME_DEFAULT = (float)LuaAPI.lua_tonumber(L, 1);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _s_set_PULL_RATIO(RealStatePtr L)
        {
		    try {
                
			    FairyGUI.ScrollPane.PULL_RATIO = (float)LuaAPI.lua_tonumber(L, 1);
