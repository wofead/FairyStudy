...
namespace XLua.CSObjectWrap
{
    ...
    public class FairyGUINTextureWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 7, 13, 7);
        ...
        static int _g_get_CustomDestroyMethod(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    translator.Push(L, FairyGUI.NTexture.CustomDestroyMethod);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _s_set_CustomDestroyMethod(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    FairyGUI.NTexture.CustomDestroyMethod = translator.GetDelegate<System.Action<UnityEngine.Texture>>(L, 1);
