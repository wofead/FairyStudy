		    ...
		    try {
                ...
                
                {
                    FairyGUI.GTreeNode _child = (FairyGUI.GTreeNode)translator.GetObject(L, 2, typeof(FairyGUI.GTreeNode));
                        ...
                        FairyGUI.GTreeNode gen_ret = gen_to_be_invoked.AddChild( _child );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    FairyGUI.GTreeNode _child = (FairyGUI.GTreeNode)translator.GetObject(L, 2, typeof(FairyGUI.GTreeNode));
                        ...
                        FairyGUI.GTreeNode gen_ret = gen_to_be_invoked.RemoveChild( _child );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    int _index = LuaAPI.xlua_tointeger(L, 2);
                        ...
                        FairyGUI.GTreeNode gen_ret = gen_to_be_invoked.RemoveChildAt( _index );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    int _index = LuaAPI.xlua_tointeger(L, 2);
                        ...
                        FairyGUI.GTreeNode gen_ret = gen_to_be_invoked.GetChildAt( _index );
                        translator.Push(L, gen_ret);
        ...
        static int _m_GetPrevSibling(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        FairyGUI.GTreeNode gen_ret = gen_to_be_invoked.GetPrevSibling(  );
                        translator.Push(L, gen_ret);
        ...
        static int _m_GetNextSibling(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        FairyGUI.GTreeNode gen_ret = gen_to_be_invoked.GetNextSibling(  );
                        translator.Push(L, gen_ret);
