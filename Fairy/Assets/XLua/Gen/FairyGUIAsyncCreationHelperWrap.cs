...
namespace XLua.CSObjectWrap
{
    ...
    public class FairyGUIAsyncCreationHelperWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(FairyGUI.AsyncCreationHelper);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					FairyGUI.AsyncCreationHelper gen_ret = new FairyGUI.AsyncCreationHelper();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to FairyGUI.AsyncCreationHelper constructor!");
