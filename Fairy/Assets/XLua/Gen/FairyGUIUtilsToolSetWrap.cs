		    ...
		    try {
                ...
                
                {
                    string _str = LuaAPI.lua_tostring(L, 1);
                        ...
                        UnityEngine.Color gen_ret = FairyGUI.Utils.ToolSet.ConvertFromHtmlColor( _str );
		    ...
		    try {
                ...
                
                {
                    int _value = LuaAPI.xlua_tointeger(L, 1);
                        ...
                        UnityEngine.Color gen_ret = FairyGUI.Utils.ToolSet.ColorFromRGB( _value );
                        translator.PushUnityEngineColor(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    uint _value = LuaAPI.xlua_touint(L, 1);
                        ...
                        UnityEngine.Color gen_ret = FairyGUI.Utils.ToolSet.ColorFromRGBA( _value );
                        translator.PushUnityEngineColor(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    char _c = (char)LuaAPI.xlua_tointeger(L, 1);
                        ...
                        int gen_ret = FairyGUI.Utils.ToolSet.CharToHex( _c );
		    ...
		    try {
                ...
                
                {
                    ...
                    UnityEngine.Rect _rect2;translator.Get(L, 2, out _rect2);
                        ...
                        UnityEngine.Rect gen_ret = FairyGUI.Utils.ToolSet.Intersection( ref _rect1, ref _rect2 );
		    ...
		    try {
                ...
                
                {
                    ...
                    UnityEngine.Rect _rect2;translator.Get(L, 2, out _rect2);
                        ...
                        UnityEngine.Rect gen_ret = FairyGUI.Utils.ToolSet.Union( ref _rect1, ref _rect2 );
                        translator.Push(L, gen_ret);
                    translator.Push(L, _rect1);
                        translator.Update(L, 1, _rect1);
