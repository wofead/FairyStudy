        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					FairyGUI.RTLSupport gen_ret = new FairyGUI.RTLSupport();
		    ...
		    try {
                ...
                
                {
                    char _ch = (char)LuaAPI.xlua_tointeger(L, 1);
                        ...
                        bool gen_ret = FairyGUI.RTLSupport.IsArabicLetter( _ch );
		    ...
		    try {
                ...
                
                {
                    string _strNumber = LuaAPI.lua_tostring(L, 1);
                        ...
                        string gen_ret = FairyGUI.RTLSupport.ConvertNumber( _strNumber );
		    ...
		    try {
                ...
                
                {
                    string _text = LuaAPI.lua_tostring(L, 1);
                        ...
                        bool gen_ret = FairyGUI.RTLSupport.ContainsArabicLetters( _text );
                        LuaAPI.lua_pushboolean(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _text = LuaAPI.lua_tostring(L, 1);
                        ...
                        FairyGUI.RTLSupport.DirectionType gen_ret = FairyGUI.RTLSupport.DetectTextDirection( _text );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _input = LuaAPI.lua_tostring(L, 1);
                        ...
                        string gen_ret = FairyGUI.RTLSupport.DoMapping( _input );
                        LuaAPI.lua_pushstring(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _source = LuaAPI.lua_tostring(L, 1);
                        ...
                        string gen_ret = FairyGUI.RTLSupport.ConvertLineL( _source );
                        LuaAPI.lua_pushstring(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _source = LuaAPI.lua_tostring(L, 1);
                        ...
                        string gen_ret = FairyGUI.RTLSupport.ConvertLineR( _source );
                        LuaAPI.lua_pushstring(L, gen_ret);
