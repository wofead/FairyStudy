...
namespace XLua.CSObjectWrap
{
    ...
    public class FairyGUIUIPackageWrap 
    {
        public static void __Register(RealStatePtr L)
        {
		    ...
		    Utils.BeginClassRegister(type, L, __CreateInstance, 19, 4, 4);
            ...
            Utils.RegisterFunc(L, Utils.CLS_GETTER_IDX, "_loadFromAssetsPath", _g_get__loadFromAssetsPath);
            Utils.RegisterFunc(L, Utils.CLS_GETTER_IDX, "_loadFromResourcesPath", _g_get__loadFromResourcesPath);
            ...
            Utils.RegisterFunc(L, Utils.CLS_SETTER_IDX, "_loadFromAssetsPath", _s_set__loadFromAssetsPath);
            Utils.RegisterFunc(L, Utils.CLS_SETTER_IDX, "_loadFromResourcesPath", _s_set__loadFromResourcesPath);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get__loadFromAssetsPath(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    translator.Push(L, FairyGUI.UIPackage._loadFromAssetsPath);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get__loadFromResourcesPath(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    translator.Push(L, FairyGUI.UIPackage._loadFromResourcesPath);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _s_set__loadFromAssetsPath(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    FairyGUI.UIPackage._loadFromAssetsPath = translator.GetDelegate<FairyGUI.UIPackage.LoadResource>(L, 1);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _s_set__loadFromResourcesPath(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    FairyGUI.UIPackage._loadFromResourcesPath = translator.GetDelegate<FairyGUI.UIPackage.LoadResource>(L, 1);
