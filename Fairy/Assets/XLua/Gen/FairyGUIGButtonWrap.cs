...
namespace XLua.CSObjectWrap
{
    ...
    public class FairyGUIGButtonWrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "relatedPageId", _g_get_relatedPageId);
            ...
            Utils.RegisterFunc(L, Utils.SETTER_IDX, "relatedPageId", _s_set_relatedPageId);
        ...
        static int _m_FireClick(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 3&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 3)) 
                {
                    ...
                    bool _clickCall = LuaAPI.lua_toboolean(L, 3);
                    
                    gen_to_be_invoked.FireClick( _downEffect, _clickCall );
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to FairyGUI.GButton.FireClick!");
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_relatedPageId(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                FairyGUI.GButton gen_to_be_invoked = (FairyGUI.GButton)translator.FastGetCSObj(L, 1);
                LuaAPI.lua_pushstring(L, gen_to_be_invoked.relatedPageId);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _s_set_relatedPageId(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                FairyGUI.GButton gen_to_be_invoked = (FairyGUI.GButton)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.relatedPageId = LuaAPI.lua_tostring(L, 2);
