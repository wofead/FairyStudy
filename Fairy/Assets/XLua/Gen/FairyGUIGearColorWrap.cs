...
namespace XLua.CSObjectWrap
{
    ...
    public class FairyGUIGearColorWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(FairyGUI.GearColor);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<FairyGUI.GObject>(L, 2))
				{
					...
					FairyGUI.GearColor gen_ret = new FairyGUI.GearColor(_owner);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to FairyGUI.GearColor constructor!");
        ...
        static int _m_Apply(RealStatePtr L)
        {
		    try {
                ...
                FairyGUI.GearColor gen_to_be_invoked = (FairyGUI.GearColor)translator.FastGetCSObj(L, 1);
