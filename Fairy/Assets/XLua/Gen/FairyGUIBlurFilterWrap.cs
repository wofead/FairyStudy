...
namespace XLua.CSObjectWrap
{
    ...
    public class FairyGUIBlurFilterWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(FairyGUI.BlurFilter);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					FairyGUI.BlurFilter gen_ret = new FairyGUI.BlurFilter();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to FairyGUI.BlurFilter constructor!");
        ...
        static int _m_Dispose(RealStatePtr L)
        {
		    try {
                ...
                FairyGUI.BlurFilter gen_to_be_invoked = (FairyGUI.BlurFilter)translator.FastGetCSObj(L, 1);
