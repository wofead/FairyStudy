        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					FairyGUI.Utils.HtmlElement gen_ret = new FairyGUI.Utils.HtmlElement();
		    ...
		    try {
                ...
                
                {
                    string _attrName = LuaAPI.lua_tostring(L, 2);
                        ...
                        object gen_ret = gen_to_be_invoked.Get( _attrName );
		    ...
		    try {
                ...
                if(gen_param_count == 2&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)) 
                {
                    string _attrName = LuaAPI.lua_tostring(L, 2);
                        ...
                        string gen_ret = gen_to_be_invoked.GetString( _attrName );
                ...
                if(gen_param_count == 3&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)&& (LuaAPI.lua_isnil(L, 3) || LuaAPI.lua_type(L, 3) == LuaTypes.LUA_TSTRING)) 
                {
                    ...
                    string _defValue = LuaAPI.lua_tostring(L, 3);
                        ...
                        string gen_ret = gen_to_be_invoked.GetString( _attrName, _defValue );
                        LuaAPI.lua_pushstring(L, gen_ret);
		    ...
		    try {
                ...
                if(gen_param_count == 2&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)) 
                {
                    string _attrName = LuaAPI.lua_tostring(L, 2);
                        ...
                        int gen_ret = gen_to_be_invoked.GetInt( _attrName );
                ...
                if(gen_param_count == 3&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)) 
                {
                    ...
                    int _defValue = LuaAPI.xlua_tointeger(L, 3);
                        ...
                        int gen_ret = gen_to_be_invoked.GetInt( _attrName, _defValue );
                        LuaAPI.xlua_pushinteger(L, gen_ret);
		    ...
		    try {
                ...
                if(gen_param_count == 2&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)) 
                {
                    string _attrName = LuaAPI.lua_tostring(L, 2);
                        ...
                        float gen_ret = gen_to_be_invoked.GetFloat( _attrName );
                ...
                if(gen_param_count == 3&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)) 
                {
                    ...
                    float _defValue = (float)LuaAPI.lua_tonumber(L, 3);
                        ...
                        float gen_ret = gen_to_be_invoked.GetFloat( _attrName, _defValue );
                        LuaAPI.lua_pushnumber(L, gen_ret);
		    ...
		    try {
                ...
                if(gen_param_count == 2&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)) 
                {
                    string _attrName = LuaAPI.lua_tostring(L, 2);
                        ...
                        bool gen_ret = gen_to_be_invoked.GetBool( _attrName );
                ...
                if(gen_param_count == 3&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 3)) 
                {
                    ...
                    bool _defValue = LuaAPI.lua_toboolean(L, 3);
                        ...
                        bool gen_ret = gen_to_be_invoked.GetBool( _attrName, _defValue );
                        LuaAPI.lua_pushboolean(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    UnityEngine.Color _defValue;translator.Get(L, 3, out _defValue);
                        ...
                        UnityEngine.Color gen_ret = gen_to_be_invoked.GetColor( _attrName, _defValue );
		    ...
		    try {
                ...
                
                {
                    FairyGUI.Utils.HtmlElementType _type;translator.Get(L, 1, out _type);
                        ...
                        FairyGUI.Utils.HtmlElement gen_ret = FairyGUI.Utils.HtmlElement.GetElement( _type );
                        translator.Push(L, gen_ret);
