...
namespace XLua.CSObjectWrap
{
    ...
    public class FairyGUIShaderConfigWrap 
    {
        public static void __Register(RealStatePtr L)
        {
		    ...
		    Utils.BeginClassRegister(type, L, __CreateInstance, 2, 20, 20);
            ...
            Utils.RegisterFunc(L, Utils.CLS_GETTER_IDX, "ID_StencilComp2", _g_get_ID_StencilComp2);
            ...
            Utils.RegisterFunc(L, Utils.CLS_SETTER_IDX, "ID_StencilComp2", _s_set_ID_StencilComp2);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_ID_StencilComp2(RealStatePtr L)
        {
		    try {
            
			    LuaAPI.xlua_pushinteger(L, FairyGUI.ShaderConfig.ID_StencilComp2);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _s_set_ID_StencilComp2(RealStatePtr L)
        {
		    try {
                
			    FairyGUI.ShaderConfig.ID_StencilComp2 = LuaAPI.xlua_tointeger(L, 1);
