...
namespace XLua.CSObjectWrap
{
    ...
    public class FairyGUIGearTextWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(FairyGUI.GearText);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<FairyGUI.GObject>(L, 2))
				{
					...
					FairyGUI.GearText gen_ret = new FairyGUI.GearText(_owner);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to FairyGUI.GearText constructor!");
        ...
        static int _m_Apply(RealStatePtr L)
        {
		    try {
                ...
                FairyGUI.GearText gen_to_be_invoked = (FairyGUI.GearText)translator.FastGetCSObj(L, 1);
