...
namespace XLua.CSObjectWrap
{
    ...
    public class FairyGUIGRootWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 23, 7, 2);
        ...
        static int _m_SetContentScaleFactor(RealStatePtr L)
        {
		    try {
                ...
                {
                    float _constantScaleFactor = (float)LuaAPI.lua_tonumber(L, 2);
                    
                    gen_to_be_invoked.SetContentScaleFactor( _constantScaleFactor );
        ...
        static int _m_ShowPopup(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 4&& translator.Assignable<FairyGUI.GObject>(L, 2)&& translator.Assignable<FairyGUI.GObject>(L, 3)&& translator.Assignable<FairyGUI.PopupDirection>(L, 4)) 
                {
                    FairyGUI.GObject _popup = (FairyGUI.GObject)translator.GetObject(L, 2, typeof(FairyGUI.GObject));
                    FairyGUI.GObject _target = (FairyGUI.GObject)translator.GetObject(L, 3, typeof(FairyGUI.GObject));
                    FairyGUI.PopupDirection _dir;translator.Get(L, 4, out _dir);
                    
                    gen_to_be_invoked.ShowPopup( _popup, _target, _dir );
                    
                    
                    
                    return 0;
                }
                if(gen_param_count == 5&& translator.Assignable<FairyGUI.GObject>(L, 2)&& translator.Assignable<FairyGUI.GObject>(L, 3)&& translator.Assignable<FairyGUI.PopupDirection>(L, 4)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 5)) 
                {
                    FairyGUI.GObject _popup = (FairyGUI.GObject)translator.GetObject(L, 2, typeof(FairyGUI.GObject));
                    FairyGUI.GObject _target = (FairyGUI.GObject)translator.GetObject(L, 3, typeof(FairyGUI.GObject));
                    FairyGUI.PopupDirection _dir;translator.Get(L, 4, out _dir);
                    bool _closeUntilUpEvent = LuaAPI.lua_toboolean(L, 5);
                    
                    gen_to_be_invoked.ShowPopup( _popup, _target, _dir, _closeUntilUpEvent );
		    ...
		    try {
                ...
                
                {
                    ...
                    FairyGUI.PopupDirection _dir;translator.Get(L, 4, out _dir);
                        ...
                        UnityEngine.Vector2 gen_ret = gen_to_be_invoked.GetPoupPosition( _popup, _target, _dir );
        ...
        static int _m_TogglePopup(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 4&& translator.Assignable<FairyGUI.GObject>(L, 2)&& translator.Assignable<FairyGUI.GObject>(L, 3)&& translator.Assignable<FairyGUI.PopupDirection>(L, 4)) 
                {
                    ...
                    gen_to_be_invoked.TogglePopup( _popup, _target, _dir );
                ...
                if(gen_param_count == 5&& translator.Assignable<FairyGUI.GObject>(L, 2)&& translator.Assignable<FairyGUI.GObject>(L, 3)&& translator.Assignable<FairyGUI.PopupDirection>(L, 4)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 5)) 
                {
                    ...
                    gen_to_be_invoked.TogglePopup( _popup, _target, _dir, _closeUntilUpEvent );
        ...
        static int _m_ShowTooltips(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 3&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)) 
                {
                    ...
                    gen_to_be_invoked.ShowTooltips( _msg, _delay );
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to FairyGUI.GRoot.ShowTooltips!");
        ...
        static int _m_ShowTooltipsWin(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 3&& translator.Assignable<FairyGUI.GObject>(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)) 
                {
                    FairyGUI.GObject _tooltipWin = (FairyGUI.GObject)translator.GetObject(L, 2, typeof(FairyGUI.GObject));
                    float _delay = (float)LuaAPI.lua_tonumber(L, 3);
                    
                    gen_to_be_invoked.ShowTooltipsWin( _tooltipWin, _delay );
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to FairyGUI.GRoot.ShowTooltipsWin!");
