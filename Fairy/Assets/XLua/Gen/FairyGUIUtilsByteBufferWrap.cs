...
namespace XLua.CSObjectWrap
{
    ...
    public class FairyGUIUtilsByteBufferWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 19, 7, 5);
		    ...
		    try {
                ...
                
                {
                    int _count = LuaAPI.xlua_tointeger(L, 2);
                        ...
                        int gen_ret = gen_to_be_invoked.Skip( _count );
        ...
        static int _m_ReadBuffer(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        FairyGUI.Utils.ByteBuffer gen_ret = gen_to_be_invoked.ReadBuffer(  );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                if(gen_param_count == 2&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)) 
                {
                    int _len = LuaAPI.xlua_tointeger(L, 2);
                        ...
                        string gen_ret = gen_to_be_invoked.ReadString( _len );
                        LuaAPI.lua_pushstring(L, gen_ret);
        ...
        static int _m_ReadS(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        string gen_ret = gen_to_be_invoked.ReadS(  );
                        LuaAPI.lua_pushstring(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    int _cnt = LuaAPI.xlua_tointeger(L, 2);
                        ...
                        string[] gen_ret = gen_to_be_invoked.ReadSArray( _cnt );
                        translator.Push(L, gen_ret);
        ...
        static int _m_ReadColor(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        UnityEngine.Color gen_ret = gen_to_be_invoked.ReadColor(  );
		    ...
		    try {
                ...
                
                {
                    ...
                    int _blockIndex = LuaAPI.xlua_tointeger(L, 3);
                        ...
                        bool gen_ret = gen_to_be_invoked.Seek( _indexTablePos, _blockIndex );
                        LuaAPI.lua_pushboolean(L, gen_ret);
