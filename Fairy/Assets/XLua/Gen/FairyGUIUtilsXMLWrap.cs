        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 2 && (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING))
				{
					...
					FairyGUI.Utils.XML gen_ret = new FairyGUI.Utils.XML(_XmlString);
		    ...
		    try {
                ...
                
                {
                    string _tag = LuaAPI.lua_tostring(L, 1);
                        ...
                        FairyGUI.Utils.XML gen_ret = FairyGUI.Utils.XML.Create( _tag );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                if(gen_param_count == 2&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)) 
                {
                    string _attrName = LuaAPI.lua_tostring(L, 2);
                        ...
                        string gen_ret = gen_to_be_invoked.GetAttribute( _attrName );
                ...
                if(gen_param_count == 3&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)&& (LuaAPI.lua_isnil(L, 3) || LuaAPI.lua_type(L, 3) == LuaTypes.LUA_TSTRING)) 
                {
                    ...
                    string _defValue = LuaAPI.lua_tostring(L, 3);
                        ...
                        string gen_ret = gen_to_be_invoked.GetAttribute( _attrName, _defValue );
                        LuaAPI.lua_pushstring(L, gen_ret);
		    ...
		    try {
                ...
                if(gen_param_count == 2&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)) 
                {
                    string _attrName = LuaAPI.lua_tostring(L, 2);
                        ...
                        int gen_ret = gen_to_be_invoked.GetAttributeInt( _attrName );
                ...
                if(gen_param_count == 3&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)) 
                {
                    ...
                    int _defValue = LuaAPI.xlua_tointeger(L, 3);
                        ...
                        int gen_ret = gen_to_be_invoked.GetAttributeInt( _attrName, _defValue );
                        LuaAPI.xlua_pushinteger(L, gen_ret);
		    ...
		    try {
                ...
                if(gen_param_count == 2&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)) 
                {
                    string _attrName = LuaAPI.lua_tostring(L, 2);
                        ...
                        float gen_ret = gen_to_be_invoked.GetAttributeFloat( _attrName );
                ...
                if(gen_param_count == 3&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)) 
                {
                    ...
                    float _defValue = (float)LuaAPI.lua_tonumber(L, 3);
                        ...
                        float gen_ret = gen_to_be_invoked.GetAttributeFloat( _attrName, _defValue );
                        LuaAPI.lua_pushnumber(L, gen_ret);
		    ...
		    try {
                ...
                if(gen_param_count == 2&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)) 
                {
                    string _attrName = LuaAPI.lua_tostring(L, 2);
                        ...
                        bool gen_ret = gen_to_be_invoked.GetAttributeBool( _attrName );
                        LuaAPI.lua_pushboolean(L, gen_ret);
                ...
                if(gen_param_count == 3&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 3)) 
                {
                    ...
                    bool _defValue = LuaAPI.lua_toboolean(L, 3);
                        ...
                        bool gen_ret = gen_to_be_invoked.GetAttributeBool( _attrName, _defValue );
                        LuaAPI.lua_pushboolean(L, gen_ret);
		    ...
		    try {
                ...
                if(gen_param_count == 2&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)) 
                {
                    string _attrName = LuaAPI.lua_tostring(L, 2);
                        ...
                        string[] gen_ret = gen_to_be_invoked.GetAttributeArray( _attrName );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 3&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)) 
                {
                    ...
                    char _seperator = (char)LuaAPI.xlua_tointeger(L, 3);
                        ...
                        string[] gen_ret = gen_to_be_invoked.GetAttributeArray( _attrName, _seperator );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    UnityEngine.Color _defValue;translator.Get(L, 3, out _defValue);
                        ...
                        UnityEngine.Color gen_ret = gen_to_be_invoked.GetAttributeColor( _attrName, _defValue );
		    ...
		    try {
                ...
                
                {
                    string _selector = LuaAPI.lua_tostring(L, 2);
                        ...
                        FairyGUI.Utils.XML gen_ret = gen_to_be_invoked.GetNode( _selector );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                if(gen_param_count == 2&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)) 
                {
                    string _selector = LuaAPI.lua_tostring(L, 2);
                        ...
                        FairyGUI.Utils.XMLList gen_ret = gen_to_be_invoked.Elements( _selector );
                        translator.Push(L, gen_ret);
