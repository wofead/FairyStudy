...
namespace XLua.CSObjectWrap
{
    ...
    public class FairyGUIUtilsHtmlImageWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(FairyGUI.Utils.HtmlImage);
			...
			Utils.RegisterFunc(L, Utils.GETTER_IDX, "loader", _g_get_loader);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					FairyGUI.Utils.HtmlImage gen_ret = new FairyGUI.Utils.HtmlImage();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to FairyGUI.Utils.HtmlImage constructor!");
        ...
        static int _m_Create(RealStatePtr L)
        {
		    try {
                ...
                FairyGUI.Utils.HtmlImage gen_to_be_invoked = (FairyGUI.Utils.HtmlImage)translator.FastGetCSObj(L, 1);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_loader(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                FairyGUI.Utils.HtmlImage gen_to_be_invoked = (FairyGUI.Utils.HtmlImage)translator.FastGetCSObj(L, 1);
                translator.Push(L, gen_to_be_invoked.loader);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
