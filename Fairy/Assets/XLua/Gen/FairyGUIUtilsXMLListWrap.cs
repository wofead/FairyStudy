        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					FairyGUI.Utils.XMLList gen_ret = new FairyGUI.Utils.XMLList();
				...
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<System.Collections.Generic.List<FairyGUI.Utils.XML>>(L, 2))
				{
					...
					FairyGUI.Utils.XMLList gen_ret = new FairyGUI.Utils.XMLList(_list);
					translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _selector = LuaAPI.lua_tostring(L, 2);
                        ...
                        FairyGUI.Utils.XMLList gen_ret = gen_to_be_invoked.Filter( _selector );
                        translator.Push(L, gen_ret);
