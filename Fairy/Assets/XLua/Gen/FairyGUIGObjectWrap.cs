...
namespace XLua.CSObjectWrap
{
    ...
    public class FairyGUIGObjectWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 37, 103, 50);
            ...
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "asLoader3D", _g_get_asLoader3D);
        ...
        static int _m_RequestFocus(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 2&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 2)) 
                {
                    bool _byKey = LuaAPI.lua_toboolean(L, 2);
                    
                    gen_to_be_invoked.RequestFocus( _byKey );
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to FairyGUI.GObject.RequestFocus!");
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_asLoader3D(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                FairyGUI.GObject gen_to_be_invoked = (FairyGUI.GObject)translator.FastGetCSObj(L, 1);
                translator.Push(L, gen_to_be_invoked.asLoader3D);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
