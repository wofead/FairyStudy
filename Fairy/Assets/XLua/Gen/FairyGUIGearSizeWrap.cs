...
namespace XLua.CSObjectWrap
{
    ...
    public class FairyGUIGearSizeWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(FairyGUI.GearSize);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<FairyGUI.GObject>(L, 2))
				{
					...
					FairyGUI.GearSize gen_ret = new FairyGUI.GearSize(_owner);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to FairyGUI.GearSize constructor!");
        ...
        static int _m_Apply(RealStatePtr L)
        {
		    try {
                ...
                FairyGUI.GearSize gen_to_be_invoked = (FairyGUI.GearSize)translator.FastGetCSObj(L, 1);
