...
namespace XLua.CSObjectWrap
{
    ...
    public class FairyGUIContainerWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 25, 12, 11);
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "GetDescendants", _m_GetDescendants);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "CreateGraphics", _m_CreateGraphics);
        ...
        static int _m_ChangeChildrenOrder(RealStatePtr L)
        {
		    try {
                ...
                {
                    System.Collections.Generic.IList<int> _indice = (System.Collections.Generic.IList<int>)translator.GetObject(L, 2, typeof(System.Collections.Generic.IList<int>));
                    System.Collections.Generic.IList<FairyGUI.DisplayObject> _objs = (System.Collections.Generic.IList<FairyGUI.DisplayObject>)translator.GetObject(L, 3, typeof(System.Collections.Generic.IList<FairyGUI.DisplayObject>));
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_CreateGraphics(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.CreateGraphics(  );
        ...
        static int _e_onUpdate(RealStatePtr L)
        {
			...
			LuaAPI.luaL_error(L, "invalid arguments to FairyGUI.Container.onUpdate!");
            return 0;
        }
