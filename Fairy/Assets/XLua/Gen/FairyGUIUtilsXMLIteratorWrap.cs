        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					FairyGUI.Utils.XMLIterator gen_ret = new FairyGUI.Utils.XMLIterator();
        ...
        static int _m_NextTag_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        bool gen_ret = FairyGUI.Utils.XMLIterator.NextTag(  );
        ...
        static int _m_GetTagSource_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        string gen_ret = FairyGUI.Utils.XMLIterator.GetTagSource(  );
		    ...
		    try {
                ...
                if(gen_param_count == 1&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 1)) 
                {
                    bool _trim = LuaAPI.lua_toboolean(L, 1);
                        ...
                        string gen_ret = FairyGUI.Utils.XMLIterator.GetRawText( _trim );
                        LuaAPI.lua_pushstring(L, gen_ret);
                ...
                if(gen_param_count == 0) 
                {
                        ...
                        string gen_ret = FairyGUI.Utils.XMLIterator.GetRawText(  );
                        LuaAPI.lua_pushstring(L, gen_ret);
		    ...
		    try {
                ...
                if(gen_param_count == 1&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 1)) 
                {
                    bool _trim = LuaAPI.lua_toboolean(L, 1);
                        ...
                        string gen_ret = FairyGUI.Utils.XMLIterator.GetText( _trim );
                        LuaAPI.lua_pushstring(L, gen_ret);
                ...
                if(gen_param_count == 0) 
                {
                        ...
                        string gen_ret = FairyGUI.Utils.XMLIterator.GetText(  );
                        LuaAPI.lua_pushstring(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _attrName = LuaAPI.lua_tostring(L, 1);
                        ...
                        bool gen_ret = FairyGUI.Utils.XMLIterator.HasAttribute( _attrName );
                        LuaAPI.lua_pushboolean(L, gen_ret);
		    ...
		    try {
                ...
                if(gen_param_count == 1&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)) 
                {
                    string _attrName = LuaAPI.lua_tostring(L, 1);
                        ...
                        string gen_ret = FairyGUI.Utils.XMLIterator.GetAttribute( _attrName );
                        LuaAPI.lua_pushstring(L, gen_ret);
                ...
                if(gen_param_count == 2&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)) 
                {
                    ...
                    string _defValue = LuaAPI.lua_tostring(L, 2);
                        ...
                        string gen_ret = FairyGUI.Utils.XMLIterator.GetAttribute( _attrName, _defValue );
                        LuaAPI.lua_pushstring(L, gen_ret);
		    ...
		    try {
                ...
                if(gen_param_count == 1&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)) 
                {
                    string _attrName = LuaAPI.lua_tostring(L, 1);
                        ...
                        int gen_ret = FairyGUI.Utils.XMLIterator.GetAttributeInt( _attrName );
                ...
                if(gen_param_count == 2&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)) 
                {
                    ...
                    int _defValue = LuaAPI.xlua_tointeger(L, 2);
                        ...
                        int gen_ret = FairyGUI.Utils.XMLIterator.GetAttributeInt( _attrName, _defValue );
                        LuaAPI.xlua_pushinteger(L, gen_ret);
		    ...
		    try {
                ...
                if(gen_param_count == 1&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)) 
                {
                    string _attrName = LuaAPI.lua_tostring(L, 1);
                        ...
                        float gen_ret = FairyGUI.Utils.XMLIterator.GetAttributeFloat( _attrName );
                ...
                if(gen_param_count == 2&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)) 
                {
                    ...
                    float _defValue = (float)LuaAPI.lua_tonumber(L, 2);
                        ...
                        float gen_ret = FairyGUI.Utils.XMLIterator.GetAttributeFloat( _attrName, _defValue );
                        LuaAPI.lua_pushnumber(L, gen_ret);
		    ...
		    try {
                ...
                if(gen_param_count == 1&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)) 
                {
                    string _attrName = LuaAPI.lua_tostring(L, 1);
                        ...
                        bool gen_ret = FairyGUI.Utils.XMLIterator.GetAttributeBool( _attrName );
                        LuaAPI.lua_pushboolean(L, gen_ret);
                ...
                if(gen_param_count == 2&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 2)) 
                {
                    ...
                    bool _defValue = LuaAPI.lua_toboolean(L, 2);
                        ...
                        bool gen_ret = FairyGUI.Utils.XMLIterator.GetAttributeBool( _attrName, _defValue );
                        LuaAPI.lua_pushboolean(L, gen_ret);
		    ...
		    try {
                ...
                if(gen_param_count == 1&& translator.Assignable<System.Collections.Generic.Dictionary<string, string>>(L, 1)) 
                {
                    System.Collections.Generic.Dictionary<string, string> _result = (System.Collections.Generic.Dictionary<string, string>)translator.GetObject(L, 1, typeof(System.Collections.Generic.Dictionary<string, string>));
                        ...
                        System.Collections.Generic.Dictionary<string, string> gen_ret = FairyGUI.Utils.XMLIterator.GetAttributes( _result );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 1&& translator.Assignable<System.Collections.Hashtable>(L, 1)) 
                {
                    System.Collections.Hashtable _result = (System.Collections.Hashtable)translator.GetObject(L, 1, typeof(System.Collections.Hashtable));
                        ...
                        System.Collections.Hashtable gen_ret = FairyGUI.Utils.XMLIterator.GetAttributes( _result );
                        translator.Push(L, gen_ret);
